export default function TechnikInformatykPage() {
  return (
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl text-gray-400">
              Kompleksowe przygotowanie do egzaminów INF.02 i INF.03
            </p>
          </div>
          ...
          <div className="mb-16">
            <div className="bg-[#0a0a0a]/50 backdrop-blur-sm border border-[#1e1e1e] rounded-xl p-8">
              <h2 className="text-3xl font-bold text-white mb-6">INF.02</h2>
          ...
          <div className="mt-12 text-center">
            <a 
              href="/platnosc?course=technik-informatyk" 
