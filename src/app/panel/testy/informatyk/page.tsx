...
export default function InformatykTestyPage() {
  ...
  if (!session?.user?.courses?.includes("Technik Informatyk")) {
  ...
  const tests: Test[] = [
    {
      id: "inf02",
      name: questions.inf02.name,
      questions: questions.inf02.questions
    },
    {
      id: "inf03",
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-500 text-transparent bg-clip-text mb-8">
          Testy kwalifikacyjne - Technik Informatyk
        </h1>
